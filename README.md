...
The `data/` directory contains processed Milan (Telecom Internet), Finland (Urban Wi-Fi), and Taiwan (Vehicular GCT) subsets used by the example configs. If you publish the code without bundling the CSV files, replace this directory with a public dataset link and keep the same filenames.
